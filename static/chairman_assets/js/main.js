...
//        selectBtn = optionMenu.querySelector(".select-btnnn"),
...
function downloadCSV() {
  ...
  table.querySelectorAll("tr").forEach(function(row) {
      var rowData = [];
      // Iterate over each cell in the row, starting from the second cell
      Array.from(row.querySelectorAll("td, th")).slice(1).forEach(function(cell) {
          // Add cell content to rowData array
          rowData.push(cell.innerText);
      });
      // Join the cell data with commas and push to the CSV array
